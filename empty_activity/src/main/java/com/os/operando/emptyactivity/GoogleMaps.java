    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            case R.id.B_hospitals:
                ...
                Toast.makeText(GoogleMaps.this, "Showing Nearby Domino's locations", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_schools:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(GoogleMaps.this, "Showing Nearby Schools", Toast.LENGTH_SHORT).show();
                break;
